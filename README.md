...
This is a proof-of-concept program that checks for the `feature@zstd_compress` ZFS feature only. Other features that affect bootability will be added after confirming approach.
